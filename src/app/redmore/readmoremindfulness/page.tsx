  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          {" "}
          In this section, you will use mindfulness to help you slow down and be
          present in the moment. Mindfulness is a mental state achieved by
          focusing awareness on the present moment, while calmly acknowledging
          and accepting feelings, thoughts, and bodily sensations.Practicing
          mindfulness can help you reduce stress and feel more relaxed. So let
          yourself get immersed in the exercises in this section, and be guided
          by audio.
          <br />
